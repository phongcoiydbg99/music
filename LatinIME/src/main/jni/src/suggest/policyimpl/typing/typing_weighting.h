...
class TypingWeighting : public Weighting {
 ...
 protected:
    ...
    float getMatchedCost(const DicTraverseSession *const traverseSession,
        ...
        //Bkav AnhNDd: Trong getProximityInfoState đã tính trước các normalizedSquaredLength
        //normalizedSquaredLength : là khoảng khác từ vị trí trung tâm(center) của key với tọa độ x,y mình bấm xuống
        //-> Nếu mà tọa độ bấm càng nhỏ thì điểm n
