...
class DicNodesCache {
 public:
    ...
    //AnhNDd: lấy ra input size từ lần cache trước
    int lastCachedInputIndex() const { return mLastCachedInputIndex; }
    void setLastCachedInputIndex(int size) {  mLastCachedInputIndex = size; }
