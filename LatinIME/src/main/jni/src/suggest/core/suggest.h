...
class Suggest : public SuggestInterface {
 public:
    ...
    //AnhNDd:
    void getNextNodeSuggestions(void *traverseSession,int *inputCodePoints, int inputSize,
                                int *outputNodeCodePoints,int *outputNodeScores,int *outputNodeCount) const;
    //AnhNDd: Tính điểm cho mỗi node
    int getNextNodeScore(void *traverseSession, DicNode *dicNode, int inputSize)const;
