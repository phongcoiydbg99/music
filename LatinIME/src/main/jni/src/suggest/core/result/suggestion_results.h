...
class SuggestionResults {
 public:
    ...
    //AnhNDd: xử lý out suggestion cho đoán node sẽ gõ tiếp theo
    void outputNextNodePredictions(int *outputNodeCodePoints, int *outputNodeScores, int *outputNodeCount);
