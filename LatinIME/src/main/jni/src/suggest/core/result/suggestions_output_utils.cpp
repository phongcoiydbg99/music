...
/* static */ void SuggestionsOutputUtils::outputSuggestionsOfDicNode(
    ...
    // shortcuts if any.
    //AnhNDd: Với cách làm hiện tại thì với từ điển telex để autocorrect thì cái shortcut của nó mới là
    //từ gợi ý mà mình commit lên để tự động sửa, còn cái word hiện tại chỉ dùng để search thôi.
    ...
    if (!terminalDicNode->hasMultipleWords() && !USE_DICT_AUTOCORRECT) { //AnhNDd: với từ điển để autocorrect thì không lấy shotcuts
