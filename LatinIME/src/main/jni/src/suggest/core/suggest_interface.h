...
class SuggestInterface {
 public:
    ...
    //AnhNDd:
    virtual void getNextNodeSuggestions(void *traverseSession,int *inputCodePoints, int inputSize,
                                        int *outputNodeCodePoints,int *outputNodeScores,int *outputNodeCount) const = 0;
