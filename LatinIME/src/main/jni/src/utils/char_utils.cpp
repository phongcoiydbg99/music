...
//AnhNDd: struct base char VN
    struct StructBaseCharVN{
        unsigned short basechar;
        unsigned short codepoint;
    };
//AnhNDd: Tu code point ve ki tu co ban "ớ->o"
/*static*/ const struct StructBaseCharVN BASE_CHARS_VN[]={
            { 0x0041, 0x1EA0 },
            { 0x0041, 0x1EA1 },
            { 0x0041, 0x1EA2 },//  A
            { 0x0041, 0x1EA3 },
...
//AnhNDd:Tu code point ve ki tu co mu "ớ->ơ"
/*static*/ const struct StructBaseCharVN LOWER_BASE_CHARS_VN[]={
            { 0x00C2, 0x1EA4 },
            { 0x00C2, 0x1EA5 },
            { 0x00C2, 0x1EA6 },
            { 0x00C2, 0x1EA7 },
...
//AnhNDd: kiem tra them mot so truong hop voi chu cai viet nam
/*static*/ int CharUtils::toLowerBaseCharVN(int c){
        for(int i=0;i<NELEMS(LOWER_BASE_CHARS_VN);i++){
            if(static_cast<int>(LOWER_BASE_CHARS_VN[i].codepoint)==c)
                return static_cast<int>(LOWER_BASE_CHARS_VN[i].basechar);
        }
        return c;
    }
/*static*/ int CharUtils::toBaseCodePointVN(int c){
        for(int i=0;i<NELEMS(BASE_CHARS_VN);i++){
            if(static_cast<int>(BASE_CHARS_VN[i].codepoint)==c)
                return static_cast<int>(BASE_CHARS_VN[i].basechar);
        }
        return c;
    }
