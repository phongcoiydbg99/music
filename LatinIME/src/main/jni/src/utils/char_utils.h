...
class CharUtils {
 public:
    ...
    //AnhNDd:
    static int toLowerBaseCharVN(int codepoint);
    static AK_FORCE_INLINE int toBaseCharVN(const int c) {
        return toLowerCase(toBaseCodePointVN(c));
    }
    static int toBaseCodePointVN(int codepoint);
    //---------------
