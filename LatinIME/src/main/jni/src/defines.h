...
#define MAX_WORD_LENGTH 572 //AnhNDd: đổi từ 48 ->572
...
//TODO: Cách dùng biến này là không chuẩn
//AnhNDd: bien toan cuc để sử dụng từ điển theo cách hợp lý
//Luu y trong viec su dung
extern bool NOT_USE_FULL_SEARCH;
extern bool USE_DICT_AUTOCORRECT;

#include <android/log.h>
#define ALOGA(fmt, ...) __android_log_print(ANDROID_LOG_INFO, "AnhNDd", fmt, ##__VA_ARGS__)
