...
public class Event {
    ...
    final /*private*/protected static int FLAG_NONE = 0;
    ...
    final /*private*/public static int FLAG_CONSUMED = 0x4;

    final /*private*/public int mEventType; // The type of event - one of the constants above
    ...
    final /*private*/public int mFlags;
    ...
    /*private*/protected Event(final int type, final CharSequence text, final int codePoint, final int keyCode,
    ...
    //==========================BKAV============================
    //AnhNDd: hàm get để lấy một số biến private
    public int getFlags(){
        return mFlags;
    }
