...
public /*final*/ class KeyboardSwitcher implements KeyboardState.SwitchActions {
    /*private*/protected static final String TAG = KeyboardSwitcher.class.getSimpleName();

    /*private*/protected InputView mCurrentInputView;
    /*private*/protected View mMainKeyboardFrame;
    /*private*/protected MainKeyboardView mKeyboardView;
    /*private*/protected EmojiPalettesView mEmojiPalettesView;
    private LatinIME mLatinIME;
    /*private*/protected RichInputMethodManager mRichImm;
    private boolean mIsHardwareAcceleratedDrawingEnabled;

    /*private*/protected KeyboardState mState;

    /*private*/protected KeyboardLayoutSet mKeyboardLayoutSet;
    // TODO: The following {@link KeyboardTextsSet} should be in {@link KeyboardLayoutSet}.
    /*private*/protected final KeyboardTextsSet mKeyboardTextsSet = /*new KeyboardTextsSet();*/createKeyboardTextsSet(); //AnhNDd

    private KeyboardTheme mKeyboardTheme;
    /*private*/protected Context mThemeContext;
    ...
    /*private*/ protected KeyboardSwitcher() {
    ...
    /*private*/protected void initInternal(final LatinIME latinIme) {
        mLatinIME = latinIme;
        //mRichImm = RichInputMethodManager.getInstance();
        //mState = new KeyboardState(this);
        //AnhNDd:
        mRichImm = createRichInputMethodManager();
        mState = createKeyboardState();
    ...
    public void loadKeyboard(final EditorInfo editorInfo, final SettingsValues settingsValues,
        ...
        //AnhNDd
        final KeyboardLayoutSet.Builder builder = createKeyboardLayoutSetBuilder(
                mThemeContext, editorInfo);
    ...
    /*private*/protected void setKeyboard(
    ...
    public View onCreateInputView(final boolean isHardwareAcceleratedDrawingEnabled) {
        ...
        //AnhNDd:
        updateKeyboardThemeAndContextThemeWrapper(mLatinIME,getKeyboardTheme());
        mCurrentInputView = createCurrentInputView();
    ...
    public KeyboardLayoutSet.Builder createKeyboardLayoutSetBuilder(final Context context, @Nullable final EditorInfo editorInfo){
        return new KeyboardLayoutSet.Builder(
                mThemeContext, editorInfo);
    }

    /**
     * AnhNDd: thực hiện inflate view
     */
    public InputView createCurrentInputView(){
        return (InputView)LayoutInflater.from(mThemeContext).inflate(
                R.layout.input_view, null);
    }

    /**
     * AnhNDd: khoi tao KeyboardTextsSet
     */
    public KeyboardTextsSet createKeyboardTextsSet(){
        return new KeyboardTextsSet();
    }

    /**
     * AnhNDd: lấy về theme theo giao diện
     */
    public KeyboardTheme getKeyboardTheme(){
        return KeyboardTheme.getKeyboardTheme(mLatinIME /* context */);
    }

    /**
     * AnhNDd: khởi tạo KeyboardState
     */
    public KeyboardState createKeyboardState(){
     ...
     * AnhNDd:
     */
    public void setWhenHideKeyboard(){
    }

    /**
     * AnhNDd: tính chiều cao của bàn phím
     */
    public int getKeyboardHeight(final Resources res, final SettingsValues settingsValues){
        return ResourceUtils.getKeyboardHeight(res, settingsValues);
    }

    /**
     * AnhNDd: create RichInputMethodManager
     */
    public RichInputMethodManager createRichInputMethodManager(){
        return RichInputMethodManager.getInstance();
    }

    /**
     * AnhNDd: xử lý việc update theme
     */
    public void handleUpdateTheme(){
