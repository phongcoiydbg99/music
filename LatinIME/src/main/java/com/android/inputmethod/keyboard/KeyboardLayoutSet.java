...
public /*final*/ class KeyboardLayoutSet {
    ...
    /*private*/protected static final String TAG_ELEMENT = "Element";
    /*private*/protected static final String TAG_FEATURE = "Feature";

    private static final String KEYBOARD_LAYOUT_SET_RESOURCE_PREFIX = "keyboard_layout_set_";

    /*private*/protected final Context mContext;
    @Nonnull
    /*private*/protected final Params mParams;
    ...
    private static final HashMap<KeyboardId, SoftReference<Keyboard>> sKeyboardCache =
            new HashMap<>();
    @Nonnull
    /*private*/protected static final UniqueKeysCache sUniqueKeysCache = UniqueKeysCache.newInstance();
    ...
    protected static final class ElementParams {
    ...
    public static final class Params {
        ...
        public final SparseArray<ElementParams> mKeyboardLayoutSetElementIdToParamsMap =
                new SparseArray<>();
    }
    ...
    protected KeyboardLayoutSet(final Context context, @Nonnull final Params params) {
        mContext = context;
        mParams = params;
    }
    ...
    public Keyboard getKeyboard(final int baseKeyboardLayoutSetElementId) {
        ...
        if (elementParams == null) {
            ...
            //AnhNDd:
            elementParams = setElementParams();
        }
    ...
    private Keyboard getKeyboard(final ElementParams elementParams, final KeyboardId id) {
        ...
        //AnhNDd:
        final KeyboardBuilder<KeyboardParams> builder = createKeyboardBuilder();
    ...
    public static /*final*/ class Builder {
        ...
        /*private*/protected final Resources mResources;
        ...
        public KeyboardLayoutSet build() {
            ...
            //AnhNDd:
            return createKeyboardLayoutSet(mContext, mParams);
        }
        ...
        /*private*/protected void parseKeyboardLayoutSetElement(final XmlPullParser parser)
                throws XmlPullParserException, IOException {
        ...
        /**
         * AnhNDd: hàm dùng để gọi hàm static sau đó ghi đè để lấy R theo BkavGTV
         */
        public int handleReadScriptIdFromTagFeature(final Resources resources,
                                                    final XmlPullParser parser) throws IOException, XmlPullParserException {
            return readScriptIdFromTagFeature(resources, parser);
        }

        /**
         * AnhNDd: thực hiện tạo đối tượng KeyboardLayoutSet
         */
        public KeyboardLayoutSet createKeyboardLayoutSet(final Context context, @Nonnull final Params params){
            return new KeyboardLayoutSet(context,params);
        }
    }

    //==========================BKAV===============================
    /**
     * AnhNDd: thực hiện khởi tạo đối tượng KeyboardBuilder
     */
    public KeyboardBuilder createKeyboardBuilder(){
        return new KeyboardBuilder<>(mContext, new KeyboardParams(sUniqueKeysCache));
    }

    /**
     * AnhNDd: lấy các thuộc tính của bàn phím
     */
    public ElementParams setElementParams(){
       return mParams.mKeyboardLayoutSetElementIdToParamsMap.get(
                KeyboardId.ELEMENT_ALPHABET);
    }
}
