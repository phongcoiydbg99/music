...
public final class KeyboardIconsSet {
    ...
    //AnhNDd:
    public static final String NAME_CURSOR_KEY = "cursor_key";
    public static final String NAME_VOICE_KEY = "voice_key";
    public static final String NAME_MINI_EMOJI = "mini_emoji";
    public static final String NAME_MINI_SETTINGS = "mini_settings";
    public static final String NAME_SHORTCUT_KEY_EMOJI = "shortcut_key_emoji";
    public static final String NAME_SPACE_BAR_ARROW_PREVIEW_LEFT_ICON = "space_bar_arrow_preview_left_icon";
    public static final String NAME_SPACE_BAR_ARROW_PREVIEW_RIGHT_ICON = "space_bar_arrow_preview_right_icon";
    ...
    private static final Object[] NAMES_AND_ATTR_IDS = {
        ...
        NAME_EMOJI_NORMAL_KEY,            R.styleable.Keyboard_iconEmojiNormalKey,
            //AnhNDd:
            NAME_CURSOR_KEY,              R.styleable.Keyboard_iconCursorKey,
            NAME_VOICE_KEY,               R.styleable.Keyboard_iconVoiceKey,
            NAME_MINI_EMOJI,                  R.styleable.Keyboard_iconEmojiMini,
            NAME_MINI_SETTINGS,               R.styleable.Keyboard_iconSettingsMini,
            NAME_SHORTCUT_KEY_EMOJI,        R.styleable.Keyboard_iconShortcutKeyEmoji,
    };
