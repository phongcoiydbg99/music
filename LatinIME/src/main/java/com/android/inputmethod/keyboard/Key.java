...
public class Key implements Comparable<Key> {
    ...
    /** Flags of the label */
    /*private*/protected final int mLabelFlags;
    ...
    /*private*/protected static final int LABEL_FLAGS_PRESERVE_CASE = 0x10000;
    ...
    /*private*/protected final int mHeight;
    /**
    ...
    @Nonnull
    /*private*/protected final Rect mHitBox = new Rect();
    ...
    /*private*/protected static final int ACTION_FLAGS_ENABLE_LONG_PRESS = 0x08;
    ...
    /*private*/protected boolean mPressed;
    ...
    public Key(@Nullable final String keySpec, @Nonnull final TypedArray keyAttr,
        ...
        /*mHitBox.set(Math.round(keyXPos), keyYPos, Math.round(keyXPos + keyWidth) + 1,
                keyYPos + rowHeight);*/
        //AnhNDd:
        setHitBox(keyXPos, keyYPos, rowHeight, keyWidth, params, keySpec);
        ...
        //AnhNDd:
        final boolean needsToUpcase = handleNeedsToUpcase(mLabelFlags, params.mId.mElementId);
        ...
        if (moreKeys != null) {
            ...
            mMoreKeys = null;
            //AnmhNDd:
            actionFlags |= setActionFlagsMoreKey(actionFlags,keySpec);
        }
    ...
    /**
     * AnhNDd: thực hiện set hitbox cho các phím bấm
     */
    public void setHitBox(float keyXPos, int keyYPos, int rowHeight, float keyWidth, final KeyboardParams params, final String keySpec) {
        mHitBox.set(Math.round(keyXPos), keyYPos, Math.round(keyXPos + keyWidth) + 1,
                keyYPos + rowHeight);
    }

    /**
     * AnhNDd: set actionFlags cho morekey bi null. Chu y dieu kien
     */
    public int setActionFlagsMoreKey(int actionFlags,String keySpec){
        return actionFlags;
    }
    ...
    /**
     * AnhNDd: Kiểm tra xem có phải key được bấm
     */
    ...
    /**
     * AnhNDd: kiểm tra xem xem có cần chữ hoa hay không
     */
    public boolean handleNeedsToUpcase(final int labelFlags, final int keyboardElementId){
        return needsToUpcase(labelFlags,keyboardElementId);
    }
}
