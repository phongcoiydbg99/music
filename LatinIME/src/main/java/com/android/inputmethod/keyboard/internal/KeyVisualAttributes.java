...
public /*final*/ class KeyVisualAttributes {
    ...
    private static final int[] VISUAL_ATTRIBUTE_IDS = {
        ...
        R.styleable.Keyboard_Key_keyHintLabelOffCenterRatio,
            //AnhNDd:
            R.styleable.Keyboard_Key_keyTextColorPressed
    };
    /*private*/protected static final SparseIntArray sVisualAttributeIds = new SparseIntArray();
    /*private*/protected static final int ATTR_DEFINED = 1;
    /*private*/protected static final int ATTR_NOT_FOUND = 0;
    static {
    ...
    /*private*/protected KeyVisualAttributes(@Nonnull final TypedArray keyAttr) {
    ...
    /**
     * AnhNDd: khởi tạo typeface
     */
    public void createTypeFace(final TypedArray keyAttr){
        if (keyAttr.hasValue(R.styleable.Keyboard_Key_keyTypeface)) {
            int id = keyAttr.getInt(R.styleable.Keyboard_Key_keyTypeface, Typeface.NORMAL);
            mTypeface = Typeface.defaultFromStyle(id > Typeface.BOLD_ITALIC ? Typeface.NORMAL : id);
        } else {
            mTypeface = null;
        }
    }
