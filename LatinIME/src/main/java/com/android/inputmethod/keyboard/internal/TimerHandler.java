...
public /*final*/ class TimerHandler extends LeakGuardHandlerWrapper<DrawingProxy>
    ...
    @Override
    public void startCodeInputRepeatTimerOf(@Nonnull PointerTracker tracker,int code, int repeatCount, int delay) {}

    @Override
    public void cancelCodeInputTimersOf(@Nonnull PointerTracker tracker) {}
}
