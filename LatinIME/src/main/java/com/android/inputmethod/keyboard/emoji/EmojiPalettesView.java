...
public /*final*/ class EmojiPalettesView extends LinearLayout implements OnTabChangeListener,
    ...
    /*private*/protected /*final*/ int mFunctionalKeyBackgroundId;
    ...
    /*private*/protected final EmojiLayoutParams mEmojiLayoutParams;
    private final DeleteKeyOnTouchListener mDeleteKeyOnTouchListener;

    private ImageButton mDeleteKey;
    private TextView mAlphabetKeyLeft;
    private TextView mAlphabetKeyRight;
    /*private*/protected View mSpacebar;
    ...
    public EmojiPalettesView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        //AnhNDd
        final KeyboardLayoutSet.Builder builder = createBuilder(context);
        final Resources res = context.getResources();
        //mEmojiLayoutParams = new EmojiLayoutParams(res);
        //AnhNDd:
        mEmojiLayoutParams = createEmojiLayoutParams(res);
        ...
        //AnhNDd:
        mDeleteKeyOnTouchListener = createDeleteKeyOnTouchListener();
    }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        final int height = /*ResourceUtils.getDefaultKeyboardHeight(res)*/getDefaultKeyboardHeight(res) //AnhNDd
    ...
    /*private*/protected static class DeleteKeyOnTouchListener implements OnTouchListener {
    ...
    public EmojiLayoutParams createEmojiLayoutParams(Resources res){
        return new EmojiLayoutParams(res);
    }

    /**
     * AnhNDd: lấy chiều cao mặc định của bàn phím
     */
    public int getDefaultKeyboardHeight(final Resources res){
        return ResourceUtils.getDefaultKeyboardHeight(res);
    }

    public DeleteKeyOnTouchListener createDeleteKeyOnTouchListener(){
        return new DeleteKeyOnTouchListener();
    }

    public KeyboardLayoutSet.Builder createBuilder(Context context){
        return new KeyboardLayoutSet.Builder(context, null /* editorInfo */);
    }
}