...
public /*final*/ class PointerTracker implements PointerTrackerQueue.Element,
    ...
    /*private*/protected static final String TAG = PointerTracker.class.getSimpleName();
    private static final boolean DEBUG_EVENT = false;
    private static final boolean DEBUG_MOVE_EVENT = false;
    private static final boolean DEBUG_LISTENER = false;
    /*private*/protected static boolean DEBUG_MODE = DebugFlags.DEBUG_ENABLED || DEBUG_EVENT;

    protected static final class PointerTrackerParams {
    ...
    /*private*/protected static PointerTrackerParams sParams;
    private static GestureStrokeRecognitionParams sGestureStrokeRecognitionParams;
    private static GestureStrokeDrawingParams sGestureStrokeDrawingParams;
    /*private*/protected static boolean sNeedsPhantomSuddenMoveEventHack;
    // Move this threshold to resource.
    // TODO: Device specific parameter would be better for device specific hack?
    private static final float PHANTOM_SUDDEN_MOVE_THRESHOLD = 0.25f; // in keyWidth

    /*private*/protected static final ArrayList<PointerTracker> sTrackers = new ArrayList<>();
    /*private*/protected static final PointerTrackerQueue sPointerTrackerQueue = new PointerTrackerQueue();

    public final int mPointerId;

    private static DrawingProxy sDrawingProxy;
    /*private*/protected static TimerProxy sTimerProxy;
    /*private*/protected static KeyboardActionListener sListener = KeyboardActionListener.EMPTY_LISTENER;
    ...
    /*private*/protected int mPhantomSuddenMoveThreshold;
    /*private*/protected final BogusMoveEventDetector mBogusMoveEventDetector = new BogusMoveEventDetector();

    /*private*/protected boolean mIsDetectingGesture = false; // per PointerTracker.
    private static boolean sInGesture = false;
    /*private*/protected static TypingTimeRecorder sTypingTimeRecorder;
    ...
    /*private*/protected Key mCurrentKey = null;
    ...
    /*private*/protected int mCurrentRepeatingKeyCode = Constants.NOT_A_CODE;

    // true if dragging finger is allowed.
    /*private*/protected boolean mIsAllowedDraggingFinger;
    ...
    public static void init(final TypedArray mainKeyboardViewAttr, final TimerProxy timerProxy,
        ...
        sNeedsPhantomSuddenMoveEventHack = Boolean.parseBoolean(
                ResourceUtils.getDeviceOverrideValue(res,
                        R.array.phantom_sudden_move_event_device_list, Boolean.TRUE.toString()));//AnhNDd: để defaul là luôn hỗ trợ do thấy nhiều máy bị trường hợp này
    ...
    /*private*/protected PointerTracker(final int id) {
        mPointerId = id;
    ...
    private void setKeyDetectorInner(final KeyDetector keyDetector) {
        ...
        //AnhNDd:
        mPhantomSuddenMoveThreshold = createPhantomSuddenMoveThreshold(keyWidth);
    ...
    /*private*/protected void setReleasedKeyGraphics(@Nullable final Key key, final boolean withAnimation) {
        if (key == null) {
            return;
        }
    ...
    /*private*/protected static int getDistance(final int x1, final int y1, final int x2, final int y2) {
    ...
    /* package */protected static int getActivePointerTrackerCount() {
...
//        Log.d("phongnve", "onMoveEvent: "+ Log.getStackTraceString(new Throwable()));
    ...
    /*private*/protected void processDraggingFingerInToNewKey(final Key newKey, final int x, final int y,
    ...
    /*private*/protected void processPhantomSuddenMoveHack(final Key key, final int x, final int y,
    ...
    /*private*/protected void processProximateBogusDownMoveUpEventHack(final Key key, final int x, final int y,
            final long eventTime, final Key oldKey, final int lastX, final int lastY) {
        if (DEBUG_MODE) {
    ...
    /*private*/protected void processDraggingFingerOutFromOldKey(final Key oldKey) {
    ...
    /*private*/protected void dragFingerFromOldKeyToNewKey(final Key key, final int x, final int y,
            final long eventTime, final Key oldKey, final int lastX, final int lastY) {
    ...
    /*private*/protected void onMoveEventInternal(final int x, final int y, final long eventTime) {
    ...
    /*private*/protected void onUpEvent(final int x, final int y, final long eventTime) {
        if (DEBUG_EVENT) {
    ...
    /*private*/public void startRepeatKey(final Key key) {
        if (sInGesture) return;
        if (key == null) return;
    ...
    /**
     * AnhNDd: xử lý trong trường hợp long press lên một key có more key là null
     */
    public void onLongPressedMoreKeyNull(){
    }

    /**
     * AnhNDd: xử lý sự kiện longclick trên phím cách
     */
    public void handleLongclickSpacebar(final int code){
        // Long pressing the space key invokes IME switcher dialog.
        if (sListener.onCustomRequest(Constants.CUSTOM_CODE_SHOW_INPUT_METHOD_PICKER)) {
            cancelKeyTracking();
            sListener.onReleaseKey(code, false /* withSliding */);
    ...
    /**
     * AnhNDd: tính khoảng cách cần thiết để trong trường hợp 2 sự kiện down thì lại thành move thì hack từ đó coi là bấm 2 phím luôn
     * để không mất chữ
     */
    public int createPhantomSuddenMoveThreshold(final int keyWidth){
        return (int)(keyWidth * PHANTOM_SUDDEN_MOVE_THRESHOLD);
    }
}
