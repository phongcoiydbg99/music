...
public /*final*/ class KeyboardTextsSet {
    ...
    public void setLocale(final Locale locale, final Resources res,
        ...
        //AnhNDd:
        mResourceLocale = setResourceLocale(locale);
    ...
    /**
     * AnhNDd: set setResourceLocale
     */
    public Locale setResourceLocale(Locale locale){
        return SubtypeLocaleUtils.NO_LANGUAGE.equals(locale.toString()) ? null : locale;
    }
}
