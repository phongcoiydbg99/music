...
public /*final*/ class MainKeyboardView extends KeyboardView implements DrawingProxy,
     ...
     */
    /*private*/protected KeyboardActionListener mKeyboardActionListener;

    /* Space key and its icon and background. */
    /*private*/protected Key mSpaceKey;
    ...
    /*private*/protected final KeyDetector mKeyDetector;
    ...
    public MainKeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        //AnhNDd
        mTimerHandler = createTimerHandler(this, ignoreAltCodeKeyTimeout, gestureRecognitionUpdateTime);
        ...
        //AnhNDd:
        mKeyDetector = createKeyDetector(keyHysteresisDistance, keyHysteresisDistanceForSlidingModifier);
        ...
        //AnhNDd:
        mKeyPreviewDrawParams = createKeyPreviewDrawParams(mainKeyboardViewAttr);
        mKeyPreviewChoreographer = createKeyPreviewChoreographer(mKeyPreviewDrawParams);
    ...
    public void setKeyboard(final Keyboard keyboard) {
        ...
        pointerTrackerSetKeyDetector(mKeyDetector);
    ...
    private void showKeyPreview(@Nonnull final Key key) {
        ...
        //AnhNDd:
        mKeyPreviewChoreographer.placeAndShowKeyPreview(key, keyboard.mIconsSet, getKeyDrawParams(),
                getWidth(), mOriginCoords, mDrawingPreviewPlacerView, showKeyPreviewWithAnimation());
    }
    ...
    public MoreKeysPanel showMoreKeysKeyboard(@Nonnull final Key key,
        ...
        //AnhNDd
        final int pointY = getPointYMoreKeyboardView(key);
    ...
    private void drawLanguageOnSpacebar(final Key key, final Canvas canvas, final Paint paint) {
        ...
        //AnhNDd:
        drawArrowOnSpaceKey(canvas, width, (int) (baseline - descent));
    }
    ...
    /**
     * AnhNDd: khởi tạo đối tượng KeyDetector
     */
    public KeyDetector createKeyDetector(final float keyHysteresisDistance,
                                         final float keyHysteresisDistanceForSlidingModifier) {
        return new KeyDetector(keyHysteresisDistance, keyHysteresisDistanceForSlidingModifier);
    }

    /**
     * AnhNDd: khởi tạo đối tượng KeyPreviewChoreographer
     */
    public KeyPreviewChoreographer createKeyPreviewChoreographer(KeyPreviewDrawParams params) {
        return new KeyPreviewChoreographer(params);
    }

    /**
     * AnhNDd: khởi tạo KeyPreviewDrawParams
     */
    public KeyPreviewDrawParams createKeyPreviewDrawParams(final TypedArray mainKeyboardViewAttr) {
        return new KeyPreviewDrawParams(mainKeyboardViewAttr);
    }

    /**
     * AnhNDd: lấy ra pointer theo id
     */
    public PointerTracker getPointerTracker(int id) {
        return PointerTracker.getPointerTracker(id);
    }

    /**
     * AnhNDd: bắt đầu việc di chuyển con trỏ
     */
    public void startViewMoveCursor() {
    }

    /**
     * AnhNDd: xác định xem có dùng animation cho việc hiển thị key preview không
     */
    public boolean showKeyPreviewWithAnimation() {
        return isHardwareAccelerated();
    }

    /**
     * AnhNDd: AnhNDd: tính tọa độ Y để hiển thị bảng morekey
     */
    public int getPointYMoreKeyboardView(Key key) {
        return key.getY() + mKeyPreviewDrawParams.getVisibleOffset();
    }

    /**
     * AnhNDd: set keydetector cho pointertracker
     */
    public void pointerTrackerSetKeyDetector(KeyDetector keyDetector) {
        PointerTracker.setKeyDetector(mKeyDetector);
    }

    /**
     * AnhNDd: vẽ 2 cái mũi tên trên phím cách
     */
    public void drawArrowOnSpaceKey(Canvas canvas, int width, int offset) {

    }

    public TimerHandler createTimerHandler(@Nonnull final DrawingProxy ownerInstance,
