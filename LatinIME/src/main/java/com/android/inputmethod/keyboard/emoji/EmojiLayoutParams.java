...
public /*final*/ class EmojiLayoutParams {
    ...
    public EmojiLayoutParams(final Resources res) {
        ...
        /*mBottomPadding = (int) res.getFraction(R.fraction.config_keyboard_bottom_padding_holo,
                defaultKeyboardHeight, defaultKeyboardHeight);*/
        //AnhNDd:
        mBottomPadding = readBottomPadding(res,defaultKeyboardHeight);
    ...
    /**
     * AnhNDd: Đọc bottompadding từ resource
     */
    public int readBottomPadding(Resources res,final int defaultKeyboardHeight){
        return (int) res.getFraction(R.fraction.config_keyboard_bottom_padding_holo,
                defaultKeyboardHeight, defaultKeyboardHeight);
    }
