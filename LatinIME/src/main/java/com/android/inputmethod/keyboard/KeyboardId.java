...
public final class KeyboardId {
    ...
    //AnhNDd: thêm Element.cho kieu go VNI
    public static final int ELEMENT_ALPHABET_VNI = 27;
    public static final int ELEMENT_SYMBOLS_VNI = 28;
    public static final int ELEMENT_SYMBOLS_SHIFTED_VNI = 29;
    public static final int ELEMENT_ALPHABET_MANUAL_SHIFTED_VNI = 30;
    public static final int ELEMENT_ALPHABET_AUTOMATIC_SHIFTED_VNI = 31;
    public static final int ELEMENT_ALPHABET_SHIFT_LOCKED_VNI = 32;
    public static final int ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED_VNI = 33;
    ...
    public static String elementIdToName(final int elementId) {
        ...
        case ELEMENT_EMOJI_CATEGORY16: return "emojiCategory16";
            //AnhNDd:
            case ELEMENT_ALPHABET_VNI: return "alphabetVNI";
            case ELEMENT_SYMBOLS_VNI: return "symbolsVNI";
            case ELEMENT_SYMBOLS_SHIFTED_VNI: return "symbolsShiftedVNI";
            case ELEMENT_ALPHABET_MANUAL_SHIFTED_VNI: return "alphabetManualShiftedVNI";
            case ELEMENT_ALPHABET_AUTOMATIC_SHIFTED_VNI: return "alphabetAutomaticShiftedVNI";
            case ELEMENT_ALPHABET_SHIFT_LOCKED_VNI: return "alphabetShiftLockedVNI";
            case ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED_VNI: return "alphabetShiftLockShiftedVNI";
            //-----------------
        default: return null;
        }
    }
