...
public abstract class Dictionary {
    ...
    //AnhNDd: thêm loại từ điển lưu lịch sử gõ chữ cái của người dùng theo kiểu telex
    public static final String TYPE_USER_HISTORY_TYPED = "history_typed";

    //AnhNDd: thêm loại từ điển dùng để cache user history
    public static final String TYPE_CACHE_USER_HISTORY = "cache_user_history";

    //AnhNDd: thêm loại từ điển dùng để autocorrect
    public static final String TYPE_MAIN_VI_AUTOCORRECT = "main_vi_autocorrect";

    //AnhNDd:Thêm loại từ điển emoji
    public static final String TYPE_EMOJI = "emoji";

    //Bkav AnhNDd: Loại từ điển tiếng việt không dấu
    public static final String TYPE_BASE_VN = "base_vn";

    public static final String TYPE_MAIN_EN = "main_en";

    /**
     * AnhNDd: kiểm tra một từ có trong từ điển hay không, không cần quan tâm đến điểm của từ
     */
    abstract public boolean hasInDictionary(final String word);
}
