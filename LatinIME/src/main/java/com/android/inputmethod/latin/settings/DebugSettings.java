...
public final class DebugSettings {
    ...
    //======================BKAV=======================
    public static final String PREF_DRAW_EXTENSION_HITBOX = "pref_draw_extension_hitbox";
    public static final String PREF_INCREASE_EXTENSION_HITBOX = "pref_increase_extension_hitbox";
    public static final String PREF_HOW_MUCH_GET_NEXT_NODE = "pref_how_much_get_next_node";
}
