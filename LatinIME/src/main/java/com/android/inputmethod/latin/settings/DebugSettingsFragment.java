...
public /*final*/ class DebugSettingsFragment extends SubScreenFragment
    ...
    /**
     * AnhNDd: setup cho thuộc tính mở rộng phím
     */
    public void setupExtensionHitbox(){
        //AnhNDd: dùng tạm cái này vì nó giống nhau
        setupKeyPreviewAnimationDuration(DebugSettings.PREF_INCREASE_EXTENSION_HITBOX, 6);
        setupKeyPreviewAnimationDuration(DebugSettings.PREF_HOW_MUCH_GET_NEXT_NODE, 18);
    }
}
