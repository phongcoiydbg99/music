...
public class RichInputMethodManager {
    /*private*/protected static final String TAG = RichInputMethodManager.class.getSimpleName();
    private static final boolean DEBUG = false;

    /*private*/protected RichInputMethodManager() {
    ...
    /*private*/protected InputMethodManagerCompatWrapper mImmWrapper;
    private InputMethodInfoCache mInputMethodInfoCache;
    private RichInputMethodSubtype mCurrentRichInputMethodSubtype;
    private InputMethodInfo mShortcutInputMethodInfo;
    private InputMethodSubtype mShortcutSubtype;

    /*private*/protected static final int INDEX_NOT_FOUND = -1;
    ...
    /*private*/protected void checkInitialized() {
        if (!isInitialized()) {
            throw new RuntimeException(TAG + " is used before initialization");
        }
    }

    /*private*/protected void initInternal(final Context context) {
        if (isInitialized()) {
            return;
        }
        ...
        //AnhNDd:
        mInputMethodInfoCache = createInputMethodInfoCache(context);
    ...
    /*private*/protected static class InputMethodInfoCache {
        ...
        public synchronized List<InputMethodSubtype> getEnabledInputMethodSubtypeList(
            ...
            //AnhNDd:
            final List<InputMethodSubtype> result = handleGetEnabledInputMethodSubtypeList(
                    imi, allowsImplicitlySelectedSubtypes);
        ...
        /**
         * AnhNDd: lấy ra danh sách các subtype đã được bật của bàn phím
         */
        public List<InputMethodSubtype> handleGetEnabledInputMethodSubtypeList(final InputMethodInfo imi, final boolean allowsImplicitlySelectedSubtypes){
            return mImm.getEnabledInputMethodSubtypeList(
                    imi, allowsImplicitlySelectedSubtypes);
        }
    }
    ...
    /*private*/protected static int getSubtypeIndexInList(final InputMethodSubtype subtype,
            final List<InputMethodSubtype> subtypes) {
    ...
    /**
     * AnhNDd: khởi tạo InputMethodInfoCache
     */
    public InputMethodInfoCache createInputMethodInfoCache(Context context){
        return new InputMethodInfoCache(
                mImmWrapper.mImm, context.getPackageName());
    }
}
