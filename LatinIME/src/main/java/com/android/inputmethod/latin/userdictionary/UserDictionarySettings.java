...
public class UserDictionarySettings extends ListFragment {
    ...
    /*private*/protected static final int OPTIONS_MENU_ADD = Menu.FIRST;
    ...
    private void showAddOrEditDialog(final String editingWord, final String editingShortcut) {
        ...
        //AnhNDd:
        startPreferencePanelAddWord(pa, args);
    }
    ...
    /**
     * AnhNDd: set fragment để thực hiện thêm từ shortcut mới
     */
    public void startPreferencePanelAddWord(android.preference.PreferenceActivity pa, final Bundle args) {
        pa.startPreferencePanel(UserDictionaryAddWordFragment.class.getName(),
                args, R.string.user_dict_settings_add_dialog_title, null, null, 0);
    }
}
