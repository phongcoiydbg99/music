...
public /*final*/ class RichInputConnection implements PrivateCommandPerformer {
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        Log.d("phongnve", "commitText: "+text);
    ...
    public TextRange getWordRangeAtCursor(final SpacingAndPunctuations spacingAndPunctuations,
        ...
        while (startIndexInBefore > 0) {
            ...
            //AnhNDd:
            boolean isPartOfCompositionForScript = handleIsPartOfCompositionForScript(codePoint, spacingAndPunctuations, scriptId);
            if (!isPartOfCompositionForScript) {
                break;
            }
     ...
     * telling us. Concretely, when the device rotates anhen d wthe keyboard reopens in the same
    ...
    /**
     * AnhNDd: kiểm tra xem các kí tự trong văn bản có cùng thuộc loại ngôn ngữ hay không
     */
    public boolean handleIsPartOfCompositionForScript(final int codePoint,
                                                             final SpacingAndPunctuations spacingAndPunctuations, final int scriptId) {
        return isPartOfCompositionForScript(codePoint, spacingAndPunctuations, scriptId);
    }
}
