...
public class NativeSuggestOptions {
    ...
    private static final int OPTIONS_SIZE = /*5*/9;
    ...
    //=================BKAV===========================
    //AnhNDd:thêm cờ option không dùng một số trường hợp để lấy gợi ý
    private static final int NOT_USE_FULL_SEARCH = 6;

    private static final int USE_DICT_AUTOCORRECT = 7;

    public void setNotUseFullSearch(final boolean value) {
        setBooleanOption(NOT_USE_FULL_SEARCH, value);
    }

    public void setUseDictAutocorrect(final boolean value) {
        setBooleanOption(USE_DICT_AUTOCORRECT, value);
    }
}
