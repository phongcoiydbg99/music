...
public final class DicTraverseSession {
    ...
    public final int[] mSpaceIndices;
    public final int[] mOutputScores;
    public final int[] mOutputTypes;
    ...
    public DicTraverseSession(Locale locale, long dictionary, long dictSize) {
        ...
        mOutputCodePoints = new int[DecoderSpecificConstants.DICTIONARY_MAX_WORD_LENGTH * MAX_RESULTS];
        mSpaceIndices = new int[MAX_RESULTS];
        mOutputScores = new int[MAX_RESULTS];
        mOutputTypes = new int[MAX_RESULTS];
    }
