...
public /*final*/ class Suggest {
    ...
    /*private*/protected float mAutoCorrectionThreshold;
    ...
    /*private*/protected static ArrayList<SuggestedWordInfo> getTransformedSuggestedWordInfoList(
    ...
    private void getSuggestedWordsForNonBatchInput(final WordComposer wordComposer,
        ...
        //AnhNDd
        hasAutoCorrection = checkHasAutoCorrection(hasAutoCorrection);
    ...
    /* package for test */protected static SuggestedWordInfo getTransformedSuggestedWordInfo(
    ...
    /**
     * AnhNDd: call back các sự kiện liên quan đến việc gõ phím tiếp theo
     */
    public interface OnGetNextNodeSuggestedCallback {
        void onGetNextNodeSuggested(final NextNodeResults nextNodes);
    }

    /**
     * AnhNDd: Nếu là bộ gõ tiếng việt thì biến này luôn false
     */
    public boolean checkHasAutoCorrection(boolean b){
        return b;
    }
}
