...
public /*final*/ class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    /*private*/ protected void onCreate(final Context context) {
        mContext = context;
        ...
        try {
            ...
            final RunInLocale<SettingsValues> job = new RunInLocale<SettingsValues>() {
                ...
                protected SettingsValues job(final Resources res) {
                    ...
                    //AnhNDd:
                    return createSettingsValues(context, prefs, res, inputAttributes);
                }
            };
    ...
    public SettingsValues createSettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
                                               @Nonnull final InputAttributes inputAttributes){
        return new SettingsValues(context, prefs, res, inputAttributes);
    }

    /**
     * AnhNDd: getcontext thong qua settings
     */
