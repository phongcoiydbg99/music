...
public /*final*/ class SetupWizardActivity extends Activity implements View.OnClickListener {
    ...
    /*private*/protected TextView mStep1Bullet;
    private TextView mActionFinish;
    /*private*/protected SetupStepGroup mSetupStepGroup;
    private static final String STATE_STEP = "step";
    /*private*/protected int mStepNumber;
    /*private*/protected boolean mNeedsToAdjustStepNumberToSystemState;
    /*private*/protected static final int STEP_WELCOME = 0;
    /*private*/protected static final int STEP_1 = 1;
    /*private*/protected static final int STEP_2 = 2;
    /*private*/protected static final int STEP_3 = 3;
    /*private*/protected static final int STEP_LAUNCHING_IME_SETTINGS = 4;
    private static final int STEP_BACK_FROM_IME_SETTINGS = 5;

    /*private*/protected SettingsPoolingHandler mHandler;

    /*private*/protected static final class SettingsPoolingHandler
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        //AnhNDd:
        setWelcomeTitle(applicationName);

        mSetupScreen = findViewById(R.id.setup_steps_screen);
        /*final TextView setStepsTitle = (TextView)findViewById(R.id.setup_title);
        setStepsTitle.setText(getString(R.string.setup_steps_title, applicationName));*/
        setStepsTitle(applicationName);
    ...
    protected void invokeSetupWizardOfThisIme() {
    ...
    /*private*/protected void invokeSettingsOfThisIme() {
        final Intent intent = new Intent();
    ...
    protected void invokeLanguageAndInputSettings() {
        final Intent intent = new Intent();
    ...
    protected void invokeInputMethodPicker() {
        // Invoke input method picker.
        mImm.showInputMethodPicker();
        mNeedsToAdjustStepNumberToSystemState = true;
    }

    protected void invokeSubtypeEnablerOfThisIme() {
    ...
    /*private*/protected int determineSetupStepNumberFromLauncher() {
    ...
    /*private*/protected void updateSetupStepView() {
        ...
        //AnhNDd:
        actionNextSetVisibility(isStepActionAlreadyDone);

        mActionFinish.setVisibility((mStepNumber == STEP_3) ? View.VISIBLE : View.GONE);
    }

    protected static /*final*/ class SetupStep implements View.OnClickListener {
        ...
        public void setEnabled(final boolean enabled, final boolean isStepActionAlreadyDone) {
            ...
            //AnhNDd:
            setTextColorBulletView(enabled);
            ...
            //AnhNDd:
            setInstructionView(isStepActionAlreadyDone);
        ...
        /**
         * AnhNDd: add mau cho mBulletView
         */
        public void setTextColorBulletView(boolean enabled){
            mBulletView.setTextColor(enabled ? mActivatedColor : mDeactivatedColor);
        }
         ...
         * AnhNDd
         */
        public void setInstructionView(boolean isStepActionAlreadyDone){
            final TextView instructionView = (TextView)mStepView.findViewById(
                    R.id.setup_step_instruction);
            instructionView.setText(isStepActionAlreadyDone ? mFinishedInstruction : mInstruction);
        }
    ...
    protected static final class SetupStepGroup {
    ...
    /**
     * AnhNDd: xu ly set contentview
     */
    public void handleSetcontentView(){
        setContentView(R.layout.setup_wizard);
    }

    /**
     * AnhNDd: setWelcomeTitle
     */
    public void setWelcomeTitle(String applicationName){
        final TextView welcomeTitle = (TextView)findViewById(R.id.setup_welcome_title);
        welcomeTitle.setText(getString(R.string.setup_welcome_title, applicationName));
    }
    ...
    public void actionNextSetVisibility(boolean isStepActionAlreadyDone){
        mActionNext.setVisibility(isStepActionAlreadyDone ? View.VISIBLE : View.GONE);
    }

    public void setIconActionFinish(){
        TextViewCompatUtils.setCompoundDrawablesRelativeWithIntrinsicBounds(mActionFinish,
                getResources().getDrawable(R.drawable.ic_setup_finish), null, null, null);
    }

    /**
     * AnhNDd : xu ly khi bam phim back
     */
    ...
    /**
     * AnhNDd: thực hiện khởi tạo các step
     */
    public void createStep(String applicationName){
        final SetupStep step1 = new SetupStep(STEP_1, applicationName,
                mStep1Bullet, findViewById(R.id.setup_step1),
                R.string.setup_step1_title, R.string.setup_step1_instruction,
                R.string.setup_step1_finished_instruction, R.drawable.ic_setup_step1,
