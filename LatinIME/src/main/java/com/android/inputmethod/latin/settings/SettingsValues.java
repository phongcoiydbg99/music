...
public class SettingsValues {
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        //AnhNDd:
        mSpacingAndPunctuations = createSpacingAndPunctuations(res);
        ...
        mShowsVoiceInputKey = needsToShowVoiceInputKey(prefs, res)
                ...
                && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && !Constants.isBCY(); //Bkav AnhNDd
        ...
        //AnhNDd: lấy giá trị các settings debug mình thêm vào
        mHasDrawExtensionHitbox = prefs.getBoolean(DebugSettings.PREF_DRAW_EXTENSION_HITBOX, false);
        mIncreaseHitbox = prefs.getInt(DebugSettings.PREF_INCREASE_EXTENSION_HITBOX,6);
        mNextNodeSize = prefs.getInt(DebugSettings.PREF_HOW_MUCH_GET_NEXT_NODE,18);
    }
    ...
    //AnhNDd: Các thuộc tính debug
    public final boolean mHasDrawExtensionHitbox;

    public final int mIncreaseHitbox;

    public final int mNextNodeSize;

    /**
     * AnhNDd: thêm các thuộc tính để dump
     */
    public void appendDump(StringBuilder sb){
    }

    public SpacingAndPunctuations createSpacingAndPunctuations(final Resources res){
